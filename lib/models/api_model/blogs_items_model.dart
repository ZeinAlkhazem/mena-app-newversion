...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    // List<DataDatum>.from(json["data"].map((x) => DataDatum.fromJson(x))),
  );
...
enum Content {
  CONTENT_CONTENT_CONTENT_CONTENT_CONTENT_CONTENT_CONTENT_CONTENT
}

final contentValues = EnumValues({
  "content content content content content content content content": Content.CONTENT_CONTENT_CONTENT_CONTENT_CONTENT_CONTENT_CONTENT_CONTENT
});
