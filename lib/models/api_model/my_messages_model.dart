...
MyMessagesModel myMessagesModelFromJson(String str) => MyMessagesModel.fromJson(json.decode(str));

String myMessagesModelToJson(MyMessagesModel data) => json.encode(data.toJson());
...
class MyMessagesModel {
  ...
  factory MyMessagesModel.fromJson(Map<String, dynamic> json) => MyMessagesModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    limit: json["limit"],
    offset: json["offset"],
    myChats:json["data"]==null?null: List<ChatItem>.from(json["data"].map((x) => ChatItem.fromJson(x))),
  );
