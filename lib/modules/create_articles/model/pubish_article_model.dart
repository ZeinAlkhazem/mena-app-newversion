...
PublishArticleModel publishArticleModelFromJson(String str) =>
    PublishArticleModel.fromJson(json.decode(str));

String publishArticleModelToJson(PublishArticleModel data) =>
...
class PublishArticleModel {
  ...
  factory PublishArticleModel.fromJson(Map<String, dynamic> json) =>
      PublishArticleModel(
