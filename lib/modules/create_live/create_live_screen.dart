                          ...
                          Column(
                            ...
                            children: [
                              LiveOptionButton(
                                  title: "Flip",
                                  iconSize: 35,
                                  icon: "assets/new_icons/live/camera.svg",
                                  btnClick: () async {
                                    startCamera();
                                  }),
                              heightBox(10.h),
                              LiveOptionButton(
                                  title: "Setting",
                                  iconSize: 35,
                                  icon: "assets/new_icons/live/settings_24.svg",
                                  btnClick: () {}),
                            ],
                          ),
                          Column(
                            ...
                            children: [
                              LiveOptionButton(
                                  ...
                                  iconSize: 35,
                                  icon:
                                      "assets/new_icons/live/poll_outline_20.svg",
                                  btnClick: () {}),
                              heightBox(10.h),
                              LiveOptionButton(
                                  title: "Live Center",
                                  iconSize: 35,
                                  icon:
                                      "assets/new_icons/live/home_outline_20.svg",
                                  btnClick: () {}),
                            ],
                          ),
                          Column(
                          ...
                          Column(
                            ...
                            children: [
                              LiveOptionButton(
                                  title: "Link",
                                  iconSize: 35,
                                  icon: "assets/new_icons/live/linked_24.svg",
                                  btnClick: () {}),
                            ],
                          ),
                          widthBox(5),
