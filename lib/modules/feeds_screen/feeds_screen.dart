...
// import 'package:mena/modules/feeds_screen/create_story.dart';
                                                                  ...
                                                                  children: [
                                                                    SizedBox(
                                                                      ...
                                                                      child: ListView.builder(
                                                                          ...
                                                                          itemCount: feedsCubit.categories.length,
                                                                          itemBuilder: (context, index) {
                                                                            return GestureDetector(
                                                                              onTap: () {
                                                                                feedsCubit.selectCategory(index);
                                                                              },
                                                                              child: Container(
                                                                                decoration: BoxDecoration(border: Border(bottom: BorderSide(color: feedsCubit.categoryId == index ? Colors.blue : Colors.grey.shade300, width: 2))),
                                                                                child: Padding(
                                                                                  padding: EdgeInsets.symmetric(vertical: 8.h, horizontal: 20.w),
                                                                                  child: Text(
                                                                                    feedsCubit.categories[index],
                                                                                    textAlign: TextAlign.center,
                                                                                    style: TextStyle(
                                                                                      color: feedsCubit.categoryId == index ? Color(0xFF202226) : Color(0xFF999B9D),
                                                                                      fontSize: 15,
                                                                                      fontFamily: 'Inter',
                                                                                                              ...
                                                                                                              child: Padding(
                                                                                                                ...
                                                                                                                child: Column(
                                                                                                                  children: [
                                                                                                                    ...
                                                                                                                    Padding(
                                                                                                                      padding: const EdgeInsets.all(8.0),
                                                                                                                      child: Text("Image", style: TextStyle(color: Colors.blue)),
                                                                                                                    )
                                                                                                                  ],
                                                                                                                ),
                                                                                                              ),
                                                                                        ...
                                                                                        child: Stack(
                                                                                          children: [
                                                                                            Container(
                                                                                              width: 77,
                                                                                              height: 77,
                                                                                              decoration: BoxDecoration(color: Colors.grey.shade100, shape: BoxShape.circle, border: Border.all(color: Colors.black.withOpacity(.25))),
                                                                                              child: Icon(
                                                                                                Icons.camera_alt,
                                                                                                color: Colors.grey,
                                                                                              ),
